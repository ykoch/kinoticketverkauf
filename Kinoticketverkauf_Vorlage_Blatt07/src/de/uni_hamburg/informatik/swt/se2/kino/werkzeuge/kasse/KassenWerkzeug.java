...
import de.uni_hamburg.informatik.swt.se2.kino.werkzeuge.oberver.Beobachter;
...
public class KassenWerkzeug implements Beobachter
{
    ...
    @Override
    public void reagiereAufAenderung(String werkzeug)
    {
    	Vorstellung vorstellung = _vorstellungAuswaehlWerkzeug.getAusgewaehlteVorstellung();
    	Tagesplan tagesplan = _kino.getTagesplan(getAusgewaehltesDatum());
    	
        switch (werkzeug) {
        case "datum": 
        	/**	System.out.println("Ich wurde benachrichtigt");*/
        	_platzVerkaufsWerkzeug.setVorstellung(vorstellung);
        	_vorstellungAuswaehlWerkzeug.setTagesplan(tagesplan);
        	break;
        case "vorstellung":
            _platzVerkaufsWerkzeug.setVorstellung(vorstellung);
        ...
        case "platz":
        	...
        	break;
        default: 
            System.out.println("Neues Werkzeug"); 
        }
